...
async function getRandomCodeWarsChallenge() {
    ...
    try {
        ...
        // Navigate to the CodeWars sign-in page
        ...
        await page.type('#user_email', 'melaniebucher830@gmail.com');
        await page.type('#user_password', 'Ninghtf69');
        await page.click('[type="submit"]');
...
async function handleUserChoice(page, browser) {
    ...
    if (choice === -1 && browser) {
        ...
        if (solution) {
            ...
            // Get the text content of the run-results div
